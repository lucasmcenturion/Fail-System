...
typedef enum { ESHANDSHAKE, ESDATOS, ESSTRING, ESARCHIVO, ESINT, ESERROR, IDENTIFICACIONINSTANCIA,SOLICITUDNOMBRE, SETINST, GETINST,
	GETENTRADAS, DUMPINSTANCIA, SETCOORD, STORECOORD, MUERTEESI, ABORTAR, SIGUIENTELINEA, REPETIRLINEA, GETPLANI,STOREINST, GETCOORD, SETOK,
	SETOKPLANI, STOREOKPLANI , STOREOK, ELIMINARCLAVE, INICIOCOMPACTACION, COMPACTACION, COMPACTACIONOK, CLAVESBLOQUEADAS} tipo;
